...
export type EvalEvent =
  ...
  | { type: 'row'; i: number; n: number; row: EvalRow; accuracy: number; elapsed: number; eta: number; avg_ms: number; query_ms: number; concurrency?: number; mem?: { ram_mb: number; vram_mb: number | null } | null }
